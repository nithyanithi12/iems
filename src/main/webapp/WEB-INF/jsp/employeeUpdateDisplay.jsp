...
<body>
	<form name="employeeCreateForm" action="setEmployeeDetails"
		...
		<table cellpadding="20px">
				...
				<td><c:choose>
						...
						<c:otherwise>
							...
							<input type="radio" name="gender" value="Female"
								checked="checked" required>Female</input>
						</c:otherwise>
					</c:choose></td>
				<td>Door No</td>
				<td><input type="text" name="doorNo" maxlength="10"
					value="${address.doorNo}" required /></td>
			</tr>
			<tr>
				<td>Date of Birth</td>
				<td><input type="date" name="dob" maxlength="30"
					min="1970-01-01" max="2001-01-01" width="100%" style="width: 100%"
					value="${employee.dob}" required /></td>

				<td>Street Name</td>
				<td><input type="text" name="street" pattern="[A-Za-z ]+"
					value="${address.street}" maxlength="30" required /></td>
			</tr>
			<tr>
				<td>Blood Group</td>
				...
				<td>Locality</td>
				<td><input type="text" name="locality" maxlength="30"
					value="${address.locality}" required /></td>
			<tr>
				<td>Mobile Number</td>
				<td><input type="tel" name="mobileNumber" maxlength="15"
					value="${employee.mobileNumber}" required /></td>
				<td>City Name</td>
			...
			<tr>
				...
				<td>State Name</td>
				<td><select name="state" maxlength="30" style="width: 100%;"
					required>
			...
			<tr>
				...
				<td><input type="date" name="doj" maxlength="30"
					min="2008-01-01" max="2019-06-31" style="width: 100%"
					value="${employee.doj}" required /><td>Pincode</td>
				<td> <input type="text" name="pincode" maxlength="30"
					value="${address.pincode}" required /></td>
          </td>				
          </tr>
          <tr>
          <td>Role</td>
          <td> <input type="text" name="role" maxlength="30"
					value="${employee.role}" required /></td>
          </tr>
          <tr>
          
          <td>Salary</td>
          <td> <input type="text" name="salary" maxlength="10"
					value="${employee.salary}" required /></td>
          </tr>
          <tr>
          
          <td>ICE Number</td>
          <td> <input type="tel" name="iceNumber" maxlength="15"
					value="${employee.iceNumber}" required /></td>
          </tr>
      </table>
    ...
    <div>
      ...
      <input type="hidden" name="id" maxlength="30" autofocus required
			value="${employee.id}" />
      <input type="button" value="Cancel"
			class="button buttonbackground"
			onclick="location.href='displayAllEmployeeRedirect.jsp';">
      <button type="submit" class="button buttonbackground"> Update </button>
      <img src="Ideas1.png" alt="Ideas2it logo"
