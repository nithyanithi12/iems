...
<html>
  ...
  <body>
    <form name="setEmployeeDetails" action="setEmployeeDetails" method="post" onSubmit="return employeeInputValidation();">
      <table cellpadding="15px">
        <tr>
          <td>Name</td>
          <td><input type="text" name="name" maxlength="30" autofocus required /></td>
          <td>E-mail</td>
        ...
        <tr>
          ...
          <td>Date of Join</td>
          <td> <input type="date" name="doj" maxlength="30" min="2008-01-01" max="2019-06-31" style="width:100%" required />
          </td>
        </tr>
        <tr>
          <td>Date of Birth</td>
          <td><input type="date" name="dob" maxlength="30"  min="1970-01-01" max="2001-01-01" width="100%" style="width:100%" required /></td>
          <td>Role</td>
        ...
        <tr>
          <td>Mobile Number</td>
          <td> <input type="tel" name="mobileNumber" maxlength="15" required /></td>
          <td>ICE Number</td>
          <td> <input type="tel" name="iceNumber" maxlength="15" required /></td>          
        </tr>
      </table>
        <p align="center">Temporaray and Permanent Address are Same <input type = "checkbox" id="checkedAddress" onclick="checkAddressType();" /></p>
      ...
      <button type = "submit" target="_self" class="button buttonbackground" > Create </button>
      <input type="button"  value= "Back" class="button buttonbackground" onclick="location.href='displayAllEmployeeRedirect.jsp';">
    </form>
  </body>
</html>
