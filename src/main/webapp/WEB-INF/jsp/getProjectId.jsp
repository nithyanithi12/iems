      ...
      <table id="getIdTable" align="center" cellpadding="20px 0px 20px 0px">
        <tr>
          <td colspan=3 align= "center" >
              <form action="singleEmployeeDisplay" method="post">
            <input type = "submit" value="Employee" class="button buttonbackground" cellpadding="0px 0px 0px 3px">
            </form>
              <form action="main" method="post">
            <input type = "submit" value = "Admin" class="button buttonbackground">
            </form>
